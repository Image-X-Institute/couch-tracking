...
input_folder = r"C:\Users\imagex_labl\Documents\Elisa\Experiments\Motion Traces"
# Output folder
output_folder = r"C:\Users\imagex_labl\Documents\Elisa\Experiments\No_7_emulator"  
...
for file_path in glob.glob(file_pattern):
    ...
    motion_mod = motion.copy()

    for i in range(1, len(motion_mod)):
        if abs(motion_mod[i] - motion_mod[i - 1]) < tol:
            motion_mod[i] += 0.1
    ...
    output_file = os.path.join(output_folder, filename.replace('_robot.txt', '.txt'))
