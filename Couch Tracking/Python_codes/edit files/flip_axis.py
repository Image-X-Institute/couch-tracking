...
input_folder = r"C:\Users\imagex_labl\Documents\Elisa\Experiments\No_6_latency\camera"

# Output folder
output_folder = r"C:\Users\imagex_labl\Documents\Elisa\Experiments\No_6_latency\camera"  
...
for file_path in glob.glob(file_pattern):
    ...
    output_file = os.path.join(output_folder, filename.replace('.csv', 'flipped.csv'))
